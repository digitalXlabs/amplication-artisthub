...
@InputType()
class SubmissionCreateNestedManyWithoutOrganizationsInput {
...
export { SubmissionCreateNestedManyWithoutOrganizationsInput as SubmissionCreateNestedManyWithoutOrganizationsInput };
